...
const App = () => {
  ...
  const {
    ...
    `${baseURL}/CategoryOne.json`,
    categoryOneActions.storeCategoryOne
  );
  const {
    dataCategoryTwo,
    errorCategoryTwo,
    isLoadingCategoryTwo,
  } = useApiFetch(
    `${baseURL}/CategoryTwo.json`,
  ...
  const {
    dataCategoryThree,
    errorCategoryThree,
    isLoadingCategoryThree,
  } = useApiFetch(
    `${baseURL}/CategoryThree.json`,
